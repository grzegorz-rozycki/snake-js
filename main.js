...
Rectangle.prototype = {
    overlap: function (R2) {
        ...
        if (R2 instanceof Rectangle) {
            return this.r >= R2.l && R2.r >= this.l && R2.b >= this.t && R2.t <= this.b;
        }
        return ans;
    }
};
// class Asset
function Asset(x, y, w, h) {
    // call parent constructor
    Rectangle.call(this, x, y, w, h);
}
Asset.prototype = new Rectangle();
...
var can = (function () {
    var canvasElm = document.getElementById('canvas'),
        API = (Object.create ? Object.create(null) : {}),
        ctx = null;
